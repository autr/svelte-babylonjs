			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.FragDepthBlock(name) : {}
				...
				export let worldPos = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:FragDepthBlock]`, ...args) : null
