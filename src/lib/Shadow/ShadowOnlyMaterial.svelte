			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ShadowOnlyMaterial(name,scene) : {}

				// ================ ACCESSORS ================

				
				export let activeLight = undefined // [ishadowlight] 
				// 
				...
				export let shadowColor = undefined // [color3] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ShadowOnlyMaterial]`, ...args) : null
				...
				if (activeLight != undefined) instance.activeLight = activeLight?.instance || activeLight
				activeLight = instance.activeLight
				...
				if (shadowColor != undefined) instance.shadowColor = shadowColor?.instance || shadowColor
