			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ShadowGeneratorSceneComponent(scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ShadowGeneratorSceneComponent]`, ...args) : null
