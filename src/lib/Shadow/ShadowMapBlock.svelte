			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ShadowMapBlock(name) : {}
				...
				export let viewProjection = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ShadowMapBlock]`, ...args) : null
				...
				viewProjection = instance.viewProjection
