			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.GradientBlock(name) : {}
				...
				export let gradient = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let colorSteps = undefined // [array] 
				...
				export let onValueChangedObservable = undefined // [observable] 
				...
				export let colorStepsUpdated = (...args) => instance.colorStepsUpdated(...args)
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:GradientBlock]`, ...args) : null
				...
				if (colorSteps != undefined) instance.colorSteps = colorSteps?.instance || colorSteps
				colorSteps = instance.colorSteps
				...
				if (onValueChangedObservable != undefined) instance.onValueChangedObservable = onValueChangedObservable?.instance || onValueChangedObservable
				onValueChangedObservable = instance.onValueChangedObservable
