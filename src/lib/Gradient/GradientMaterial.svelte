			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.GradientMaterial(name,scene) : {}
				...
				export let bottomColor = undefined // [color3] 
				// 
				

				export let bottomColorAlpha = undefined // [number] 
				// 
				...
				export let scale = undefined // [number] 
				// 
				...
				export let smoothness = undefined // [number] 
				// 
				...
				export let topColor = undefined // [color3] 
				// 
				

				export let topColorAlpha = undefined // [number] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:GradientMaterial]`, ...args) : null
				...
				if (bottomColor != undefined) instance.bottomColor = bottomColor?.instance || bottomColor
				bottomColor = instance.bottomColor
				if (bottomColorAlpha != undefined) instance.bottomColorAlpha = bottomColorAlpha?.instance || bottomColorAlpha
				bottomColorAlpha = instance.bottomColorAlpha
				...
				if (smoothness != undefined) instance.smoothness = smoothness?.instance || smoothness
				smoothness = instance.smoothness
				if (state != undefined) instance.state = state?.instance || state
				state = instance.state
				if (topColor != undefined) instance.topColor = topColor?.instance || topColor
				topColor = instance.topColor
				if (topColorAlpha != undefined) instance.topColorAlpha = topColorAlpha?.instance || topColorAlpha
				topColorAlpha = instance.topColorAlpha
