			...
			<script>
				...
				*/
				...
				export let step = undefined // [number] * required
				...
				export let instance = browser ? new BB.GradientBlockColorStep(step,color) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:GradientBlockColorStep]`, ...args) : null
