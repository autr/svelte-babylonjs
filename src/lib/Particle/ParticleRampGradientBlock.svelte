			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ParticleRampGradientBlock(name) : {}
				...
				export let rampColor = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ParticleRampGradientBlock]`, ...args) : null
