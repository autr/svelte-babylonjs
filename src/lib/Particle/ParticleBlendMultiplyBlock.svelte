			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ParticleBlendMultiplyBlock(name) : {}

				// ================ ACCESSORS ================

				
				export let alphaColor = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let alphaTexture = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let blendColor = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ParticleBlendMultiplyBlock]`, ...args) : null
				...
				alphaColor = instance.alphaColor

				alphaTexture = instance.alphaTexture

				blendColor = instance.blendColor
