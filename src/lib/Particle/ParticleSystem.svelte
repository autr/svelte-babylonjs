			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ParticleSystem(name,capacity,sceneOrEngine,customEffect,isAnimationSheetEnabled,epsilon) : {}
				...
				export let activeSubSystems = undefined // [array] 
				...
				export let defaultViewMatrix = undefined // [matrix] 
				...
				export let recycleParticle = undefined // [reflection] 
				// 
				...
				export let startDirectionFunction = undefined // [reflection] 
				// 
				

				export let startPositionFunction = undefined // [reflection] 
				// 
				...
				export let subEmitters = undefined // [array] 
				...
				export let updateFunction = undefined // [reflection] 
				// 
				

				export let updateInAnimate = undefined // [literal] 
				...
				export let isAlive = (...args) => instance.isAlive(...args)
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ParticleSystem]`, ...args) : null
				...
				if (activeSubSystems != undefined) instance.activeSubSystems = activeSubSystems?.instance || activeSubSystems
				activeSubSystems = instance.activeSubSystems
				...
				if (defaultViewMatrix != undefined) instance.defaultViewMatrix = defaultViewMatrix?.instance || defaultViewMatrix
				defaultViewMatrix = instance.defaultViewMatrix
				...
				if (recycleParticle != undefined) instance.recycleParticle = recycleParticle?.instance || recycleParticle
				recycleParticle = instance.recycleParticle
				...
				if (startDirectionFunction != undefined) instance.startDirectionFunction = startDirectionFunction?.instance || startDirectionFunction
				startDirectionFunction = instance.startDirectionFunction
				if (startPositionFunction != undefined) instance.startPositionFunction = startPositionFunction?.instance || startPositionFunction
				startPositionFunction = instance.startPositionFunction
				...
				if (subEmitters != undefined) instance.subEmitters = subEmitters?.instance || subEmitters
				subEmitters = instance.subEmitters
				...
				if (updateFunction != undefined) instance.updateFunction = updateFunction?.instance || updateFunction
				updateFunction = instance.updateFunction
