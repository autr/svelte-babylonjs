			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.EquiRectangularCubeTexture(url,scene,size,noMipmap,gammaSpace,onLoad,onError) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:EquiRectangularCubeTexture]`, ...args) : null
