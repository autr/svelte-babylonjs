			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.NormalBlendBlock(name) : {}
				...
				export let normalMap0 = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let normalMap1 = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:NormalBlendBlock]`, ...args) : null
				...
				normalMap0 = instance.normalMap0

				normalMap1 = instance.normalMap1
