			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ScreenSpaceReflectionsConfiguration() : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ScreenSpaceReflectionsConfiguration]`, ...args) : null
