			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ScreenSpaceBlock(name) : {}
				...
				export let worldViewProjection = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ScreenSpaceBlock]`, ...args) : null
				...
				worldViewProjection = instance.worldViewProjection
