			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.PointLight(name,position,scene) : {}
				...
				export let shadowAngle = undefined // [number] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:PointLight]`, ...args) : null
				...
				if (shadowAngle != undefined) instance.shadowAngle = shadowAngle?.instance || shadowAngle
