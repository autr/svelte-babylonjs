			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.AnaglyphArcRotateCamera(name,alpha,beta,radius,target,interaxialDistance,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:AnaglyphArcRotateCamera]`, ...args) : null
