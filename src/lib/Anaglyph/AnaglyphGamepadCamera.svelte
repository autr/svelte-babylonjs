			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.AnaglyphGamepadCamera(name,position,interaxialDistance,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:AnaglyphGamepadCamera]`, ...args) : null
