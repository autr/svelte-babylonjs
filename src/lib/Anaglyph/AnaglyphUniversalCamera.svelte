			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.AnaglyphUniversalCamera(name,position,interaxialDistance,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:AnaglyphUniversalCamera]`, ...args) : null
