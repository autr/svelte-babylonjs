			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.AnaglyphFreeCamera(name,position,interaxialDistance,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:AnaglyphFreeCamera]`, ...args) : null
