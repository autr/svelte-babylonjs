			...
			<script>
				...
				*/
				...
				export let instance = browser ? BB.PolygonBuilder.ExtrudePolygon(name,options,scene,earcutInjection) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ExtrudePolygon]`, ...args) : null
