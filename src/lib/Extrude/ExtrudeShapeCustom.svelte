			...
			<script>
				...
				*/
				...
				export let instance = browser ? BB.ShapeBuilder.ExtrudeShapeCustom(name,options,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ExtrudeShapeCustom]`, ...args) : null
