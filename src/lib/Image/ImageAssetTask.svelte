			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ImageAssetTask(name,url) : {}
				...
				export let image = undefined // [htmlimageelement] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ImageAssetTask]`, ...args) : null
				...
				if (image != undefined) instance.image = image?.instance || image
