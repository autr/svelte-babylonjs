			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ImageProcessingBlock(name) : {}
				...
				export let convertInputToLinearSpace = undefined // [boolean] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ImageProcessingBlock]`, ...args) : null
				...
				if (convertInputToLinearSpace != undefined) instance.convertInputToLinearSpace = convertInputToLinearSpace?.instance || convertInputToLinearSpace
				convertInputToLinearSpace = instance.convertInputToLinearSpace
