			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ReflectionBlock(name) : {}
				...
				export let cameraPosition = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let color = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let hasTexture = undefined // [boolean] 
				// 
				...
				export let reflection = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let reflectionColor = undefined // [string] 
				// 
				...
				export let view = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let world = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let worldNormal = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let worldPosition = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let generateOnlyFragmentCode = undefined // [boolean] 
				...
				// defines if the material uses spherical harmonics vs spherical polynomials for thediffuse part of the ibl.
				...
				export let getCode = (...args) => instance.getCode(...args)
				...
				export let handleFragmentSideCodeReflectionColor = (...args) => instance.handleFragmentSideCodeReflectionColor(...args)

				export let handleFragmentSideCodeReflectionCoords = (...args) => instance.handleFragmentSideCodeReflectionCoords(...args)

				export let handleFragmentSideInits = (...args) => instance.handleFragmentSideInits(...args)

				export let handleVertexSide = (...args) => instance.handleVertexSide(...args)
				...
				export let writeOutputs = (...args) => instance.writeOutputs(...args)
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ReflectionBlock]`, ...args) : null
				...
				hasTexture = instance.hasTexture
				...
				worldNormal = instance.worldNormal
				...
				if (generateOnlyFragmentCode != undefined) instance.generateOnlyFragmentCode = generateOnlyFragmentCode?.instance || generateOnlyFragmentCode
				generateOnlyFragmentCode = instance.generateOnlyFragmentCode
