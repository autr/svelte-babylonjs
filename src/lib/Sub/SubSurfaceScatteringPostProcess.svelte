			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.SubSurfaceScatteringPostProcess(name,scene,options,camera,samplingMode,engine,reusable,textureType) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:SubSurfaceScatteringPostProcess]`, ...args) : null
