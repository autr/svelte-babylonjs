			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.SubSurfaceBlock(name) : {}
				...
				export let refraction = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let subsurface = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let thickness = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let translucencyDiffusionDist = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let translucencyIntensity = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:SubSurfaceBlock]`, ...args) : null
				...
				refraction = instance.refraction

				subsurface = instance.subsurface
				...
				translucencyDiffusionDist = instance.translucencyDiffusionDist
