			...
			<script>
				...
				*/
				...
				export let value = undefined // [string] * required
				...
				export let instance = browser ? new BB.SetStateAction(triggerOptions,target,value,condition) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:SetStateAction]`, ...args) : null
