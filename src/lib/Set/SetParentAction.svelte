			...
			<script>
				...
				*/
				...
				// defines the target containing the parent property
				

				export let parent = undefined // [any] * required
				...
				export let instance = browser ? new BB.SetParentAction(triggerOptions,target,parent,condition) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:SetParentAction]`, ...args) : null
