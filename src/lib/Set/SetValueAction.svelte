			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.SetValueAction(triggerOptions,target,propertyPath,value,condition) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:SetValueAction]`, ...args) : null
