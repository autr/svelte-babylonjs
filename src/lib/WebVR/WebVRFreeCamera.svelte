			...
			<script>
				...
				*/
				...
				export let _webVROptions = undefined // [webvroptions] 
				// a set of customizable options for the webvrcamera
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.WebVRFreeCamera(name,position,scene,_webVROptions) : {}
				...
				export let leftController = undefined // [nullable] 
				// 
				...
				export let rightController = undefined // [nullable] 
				// 
				...
				export let onControllerMeshLoadedObservable = undefined // [observable] 
				// emits an event when a controller's mesh has been loaded;
				

				export let onControllersAttachedObservable = undefined // [observable] 
				...
				export let onPoseUpdatedFromDeviceObservable = undefined // [observable] 
				...
				export let rawPose = undefined // [nullable] 
				...
				export let rigParenting = undefined // [boolean] 
				...
				export let deviceDistanceToRoomGround = (...args) => instance.deviceDistanceToRoomGround(...args)
				...
				export let getControllerByName = (...args) => instance.getControllerByName(...args)
				...
				export let initControllers = (...args) => instance.initControllers(...args)
				...
				export let resetToCurrentRotation = (...args) => instance.resetToCurrentRotation(...args)
				...
				export let useStandingMatrix = (...args) => instance.useStandingMatrix(...args)

				export let useStandingMatrixAsync = (...args) => instance.useStandingMatrixAsync(...args)
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:WebVRFreeCamera]`, ...args) : null
				...
				if (_webVROptions != undefined) instance._webVROptions = _webVROptions?.instance || _webVROptions
				_webVROptions = instance._webVROptions
				...
				leftController = instance.leftController
				...
				rightController = instance.rightController
				...
				if (onControllerMeshLoadedObservable != undefined) instance.onControllerMeshLoadedObservable = onControllerMeshLoadedObservable?.instance || onControllerMeshLoadedObservable
				onControllerMeshLoadedObservable = instance.onControllerMeshLoadedObservable
				if (onControllersAttachedObservable != undefined) instance.onControllersAttachedObservable = onControllersAttachedObservable?.instance || onControllersAttachedObservable
				onControllersAttachedObservable = instance.onControllersAttachedObservable
				...
				if (onPoseUpdatedFromDeviceObservable != undefined) instance.onPoseUpdatedFromDeviceObservable = onPoseUpdatedFromDeviceObservable?.instance || onPoseUpdatedFromDeviceObservable
				onPoseUpdatedFromDeviceObservable = instance.onPoseUpdatedFromDeviceObservable
				...
				if (rigParenting != undefined) instance.rigParenting = rigParenting?.instance || rigParenting
				rigParenting = instance.rigParenting
