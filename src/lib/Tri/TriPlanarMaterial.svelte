			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.TriPlanarMaterial(name,scene) : {}
				...
				export let diffuseTextureX = undefined // [basetexture] 
				// 
				

				export let diffuseTextureY = undefined // [basetexture] 
				// 
				

				export let diffuseTextureZ = undefined // [basetexture] 
				// 
				...
				export let mixTexture = undefined // [basetexture] 
				// 
				

				export let normalTextureX = undefined // [basetexture] 
				// 
				

				export let normalTextureY = undefined // [basetexture] 
				// 
				

				export let normalTextureZ = undefined // [basetexture] 
				// 
				...
				export let tileSize = undefined // [number] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:TriPlanarMaterial]`, ...args) : null
				...
				if (diffuseTextureX != undefined) instance.diffuseTextureX = diffuseTextureX?.instance || diffuseTextureX
				diffuseTextureX = instance.diffuseTextureX
				if (diffuseTextureY != undefined) instance.diffuseTextureY = diffuseTextureY?.instance || diffuseTextureY
				diffuseTextureY = instance.diffuseTextureY
				if (diffuseTextureZ != undefined) instance.diffuseTextureZ = diffuseTextureZ?.instance || diffuseTextureZ
				diffuseTextureZ = instance.diffuseTextureZ
				...
				if (mixTexture != undefined) instance.mixTexture = mixTexture?.instance || mixTexture
				mixTexture = instance.mixTexture
				if (normalTextureX != undefined) instance.normalTextureX = normalTextureX?.instance || normalTextureX
				normalTextureX = instance.normalTextureX
				if (normalTextureY != undefined) instance.normalTextureY = normalTextureY?.instance || normalTextureY
				normalTextureY = instance.normalTextureY
				if (normalTextureZ != undefined) instance.normalTextureZ = normalTextureZ?.instance || normalTextureZ
				normalTextureZ = instance.normalTextureZ
				...
				if (tileSize != undefined) instance.tileSize = tileSize?.instance || tileSize
