			...
			<script>
				...
				*/
				...
				export let hideSourceZ = undefined // [boolean] 
				// 
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.TriPlanarBlock(name,hideSourceZ) : {}

				// ================ ACCESSORS ================

				
				export let a = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let b = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let convertToGammaSpace = undefined // [boolean] 
				// 
				

				export let convertToLinearSpace = undefined // [boolean] 
				// 
				

				export let g = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let hasImageSource = undefined // [boolean] 
				// 
				...
				export let level = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let normal = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let position = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let r = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let rgb = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let rgba = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let samplerName = undefined // [string] 
				// 
				

				export let samplerYName = undefined // [nullable] 
				// 
				

				export let samplerZName = undefined // [nullable] 
				// 
				

				export let sharpness = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let source = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let sourceY = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let sourceZ = undefined // [nullable] 
				// 
				...
				export let textureY = undefined // [nullable] 
				// 
				

				export let textureZ = undefined // [nullable] 
				// 
				...
				export let disableLevelMultiplication = undefined // [boolean] 
				...
				export let _deserialize = (...args) => instance._deserialize(...args)
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:TriPlanarBlock]`, ...args) : null
				...
				name = instance.name
				if (hideSourceZ != undefined) instance.hideSourceZ = hideSourceZ?.instance || hideSourceZ
				hideSourceZ = instance.hideSourceZ
				...
				if (convertToGammaSpace != undefined) instance.convertToGammaSpace = convertToGammaSpace?.instance || convertToGammaSpace
				convertToGammaSpace = instance.convertToGammaSpace
				if (convertToLinearSpace != undefined) instance.convertToLinearSpace = convertToLinearSpace?.instance || convertToLinearSpace
				convertToLinearSpace = instance.convertToLinearSpace

				g = instance.g

				hasImageSource = instance.hasImageSource
				...
				samplerName = instance.samplerName

				samplerYName = instance.samplerYName

				samplerZName = instance.samplerZName

				sharpness = instance.sharpness

				source = instance.source

				sourceY = instance.sourceY

				sourceZ = instance.sourceZ
				...
				textureY = instance.textureY

				textureZ = instance.textureZ
				...
				if (disableLevelMultiplication != undefined) instance.disableLevelMultiplication = disableLevelMultiplication?.instance || disableLevelMultiplication
				disableLevelMultiplication = instance.disableLevelMultiplication
