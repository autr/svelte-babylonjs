			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.DeviceOrientationCamera(name,position,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:DeviceOrientationCamera]`, ...args) : null
