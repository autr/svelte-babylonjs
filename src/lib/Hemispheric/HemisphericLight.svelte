			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.HemisphericLight(name,direction,scene) : {}
				...
				export let groundColor = undefined // [color3] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:HemisphericLight]`, ...args) : null
				...
				if (groundColor != undefined) instance.groundColor = groundColor?.instance || groundColor
				groundColor = instance.groundColor
