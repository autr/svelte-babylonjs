			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.HemisphericParticleEmitter(radius,radiusRange,directionRandomizer) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:HemisphericParticleEmitter]`, ...args) : null
