			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.CylinderParticleEmitter(radius,height,radiusRange,directionRandomizer) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CylinderParticleEmitter]`, ...args) : null
