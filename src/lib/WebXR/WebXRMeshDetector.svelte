			...
			<script>
				...
				*/
				...
				export let _options = undefined // [iwebxrmeshdetectoroptions] 
				// 
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.WebXRMeshDetector(_xrSessionManager,_options) : {}
				...
				export let onMeshAddedObservable = undefined // [observable] 
				...
				export let onMeshUpdatedObservable = undefined // [observable] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:WebXRMeshDetector]`, ...args) : null
				...
				if (onMeshAddedObservable != undefined) instance.onMeshAddedObservable = onMeshAddedObservable?.instance || onMeshAddedObservable
				onMeshAddedObservable = instance.onMeshAddedObservable
				...
				if (onMeshUpdatedObservable != undefined) instance.onMeshUpdatedObservable = onMeshUpdatedObservable?.instance || onMeshUpdatedObservable
				onMeshUpdatedObservable = instance.onMeshUpdatedObservable
