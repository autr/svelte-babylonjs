			...
			<script>
				...
				*/
				...
				export let _options = undefined // [iwebxrcontrollerphysicsoptions] * required
				// options to create this feature with
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.WebXRControllerPhysics(_xrSessionManager,_options) : {}
				...
				export let addController = (...args) => instance.addController(...args)
				...
				export let getHeadsetImpostor = (...args) => instance.getHeadsetImpostor(...args)

				export let getImpostorForController = (...args) => instance.getImpostorForController(...args)

				export let isCompatible = (...args) => instance.isCompatible(...args)

				export let setPhysicsProperties = (...args) => instance.setPhysicsProperties(...args)
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:WebXRControllerPhysics]`, ...args) : null
