			...
			<script>
				...
				*/
				...
				export let options = undefined // [iwebxrdomoverlayoptions] * required
				// options to use when constructing this feature
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.WebXRDomOverlay(_xrSessionManager,options) : {}
				...
				export let domOverlayType = undefined // [nullable] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:WebXRDomOverlay]`, ...args) : null
				...
				domOverlayType = instance.domOverlayType
