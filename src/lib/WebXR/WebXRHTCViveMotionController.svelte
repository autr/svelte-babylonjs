			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.WebXRHTCViveMotionController(scene,gamepadObject,handedness) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:WebXRHTCViveMotionController]`, ...args) : null
