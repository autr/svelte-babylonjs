			...
			<script>
				...
				*/
				...
				export let options = undefined // [iwebxrbackgroundremoveroptions] 
				// read-only options to be used in this module
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.WebXRBackgroundRemover(_xrSessionManager,options) : {}
				...
				export let onBackgroundStateChangedObservable = undefined // [observable] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:WebXRBackgroundRemover]`, ...args) : null
				...
				if (onBackgroundStateChangedObservable != undefined) instance.onBackgroundStateChangedObservable = onBackgroundStateChangedObservable?.instance || onBackgroundStateChangedObservable
				onBackgroundStateChangedObservable = instance.onBackgroundStateChangedObservable
