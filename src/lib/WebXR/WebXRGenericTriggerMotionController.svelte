			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.WebXRGenericTriggerMotionController(scene,gamepadObject,handedness) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:WebXRGenericTriggerMotionController]`, ...args) : null
