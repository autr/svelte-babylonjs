			...
			<script>
				...
				*/
				...
				export let options = undefined // [iwebxrlegacyhittestoptions] 
				// options to use when constructing this feature
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.WebXRHitTestLegacy(_xrSessionManager,options) : {}
				...
				export let lastNativeXRHitResults = undefined // [array] 
				...
				export let XRHitTestWithRay = (...args) => instance.XRHitTestWithRay(...args)

				export let XRHitTestWithSelectEvent = (...args) => instance.XRHitTestWithSelectEvent(...args)
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:WebXRHitTestLegacy]`, ...args) : null
				...
				if (lastNativeXRHitResults != undefined) instance.lastNativeXRHitResults = lastNativeXRHitResults?.instance || lastNativeXRHitResults
				lastNativeXRHitResults = instance.lastNativeXRHitResults
