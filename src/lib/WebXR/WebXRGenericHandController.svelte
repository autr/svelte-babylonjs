			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.WebXRGenericHandController(scene,gamepadObject,handedness) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:WebXRGenericHandController]`, ...args) : null
