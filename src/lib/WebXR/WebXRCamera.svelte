			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.WebXRCamera(name,scene,_xrSessionManager) : {}
				...
				export let realWorldHeight = undefined // [number] 
				// 
				...
				export let trackingState = undefined // [webxrtrackingstate] 
				// 
				...
				export let compensateOnFirstFrame = undefined // [boolean] 
				...
				export let onAfterCameraTeleport = undefined // [observable] 
				...
				export let onBeforeCameraTeleport = undefined // [observable] 
				...
				export let onTrackingStateChanged = undefined // [observable] 
				...
				export let setTransformationFromNonVRCamera = (...args) => instance.setTransformationFromNonVRCamera(...args)
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:WebXRCamera]`, ...args) : null
				...
				realWorldHeight = instance.realWorldHeight
				...
				trackingState = instance.trackingState
				...
				if (compensateOnFirstFrame != undefined) instance.compensateOnFirstFrame = compensateOnFirstFrame?.instance || compensateOnFirstFrame
				compensateOnFirstFrame = instance.compensateOnFirstFrame
				...
				if (onAfterCameraTeleport != undefined) instance.onAfterCameraTeleport = onAfterCameraTeleport?.instance || onAfterCameraTeleport
				onAfterCameraTeleport = instance.onAfterCameraTeleport
				...
				if (onBeforeCameraTeleport != undefined) instance.onBeforeCameraTeleport = onBeforeCameraTeleport?.instance || onBeforeCameraTeleport
				onBeforeCameraTeleport = instance.onBeforeCameraTeleport
				...
				if (onTrackingStateChanged != undefined) instance.onTrackingStateChanged = onTrackingStateChanged?.instance || onTrackingStateChanged
				onTrackingStateChanged = instance.onTrackingStateChanged
