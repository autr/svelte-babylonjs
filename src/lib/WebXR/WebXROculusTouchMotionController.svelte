			...
			<script>
				...
				*/
				...
				export let _legacyMapping = undefined // [boolean] 
				// 
				

				export let _forceLegacyControllers = undefined // [boolean] 
				// 
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.WebXROculusTouchMotionController(scene,gamepadObject,handedness,_legacyMapping,_forceLegacyControllers) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:WebXROculusTouchMotionController]`, ...args) : null
				...
				if (_legacyMapping != undefined) instance._legacyMapping = _legacyMapping?.instance || _legacyMapping
				_legacyMapping = instance._legacyMapping
				if (_forceLegacyControllers != undefined) instance._forceLegacyControllers = _forceLegacyControllers?.instance || _forceLegacyControllers
				_forceLegacyControllers = instance._forceLegacyControllers
