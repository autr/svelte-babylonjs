			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.RawTexture2DArray(data,width,height,depth,format,scene,generateMipMaps,invertY,samplingMode,textureType) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:RawTexture2DArray]`, ...args) : null
