			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.RawTexture3D(data,width,height,depth,format,scene,generateMipMaps,invertY,samplingMode,textureType) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:RawTexture3D]`, ...args) : null
