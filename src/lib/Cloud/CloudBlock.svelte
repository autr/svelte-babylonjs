			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.CloudBlock(name) : {}
				...
				export let chaos = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let offsetX = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let offsetY = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let offsetZ = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let seed = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let octaves = undefined // [number] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CloudBlock]`, ...args) : null
				...
				if (octaves != undefined) instance.octaves = octaves?.instance || octaves
				octaves = instance.octaves
