			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.CircleOfConfusionPostProcess(name,depthTexture,options,camera,samplingMode,engine,reusable,textureType,blockCompilation) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CircleOfConfusionPostProcess]`, ...args) : null
