			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.RefractionTexture(name,size,scene,generateMipMaps) : {}
				...
				export let depth = undefined // [number] 
				...
				export let refractionPlane = undefined // [plane] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:RefractionTexture]`, ...args) : null
				...
				if (refractionPlane != undefined) instance.refractionPlane = refractionPlane?.instance || refractionPlane
				refractionPlane = instance.refractionPlane
