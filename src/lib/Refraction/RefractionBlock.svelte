			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.RefractionBlock(name) : {}
				...
				export let volumeIndexOfRefraction = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:RefractionBlock]`, ...args) : null
