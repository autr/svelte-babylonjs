			...
			<script>
				...
				*/
				...
				export let fragment = undefined // [any] * required
				...
				export let fallbackTexture = undefined // [nullable] 
				...
				export let instance = browser ? new BB.ProceduralTexture(name,size,fragment,scene,fallbackTexture,generateMipMaps,isCube,textureType) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ProceduralTexture]`, ...args) : null
				...
				size = instance.size
				if (fragment != undefined) instance.fragment = fragment?.instance || fragment
