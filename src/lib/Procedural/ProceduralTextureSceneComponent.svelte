			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ProceduralTextureSceneComponent(scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ProceduralTextureSceneComponent]`, ...args) : null
