			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ScaleGizmo(gizmoLayer,thickness,gizmoManager) : {}
				...
				export let uniformScaleGizmo = undefined // [iaxisscalegizmo] 
				// internal gizmo used to scale all axis equally
				

				export let xGizmo = undefined // [iaxisscalegizmo] 
				// internal gizmo used for interactions on the x axis
				

				export let yGizmo = undefined // [iaxisscalegizmo] 
				// internal gizmo used for interactions on the y axis
				

				export let zGizmo = undefined // [iaxisscalegizmo] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ScaleGizmo]`, ...args) : null
				...
				if (uniformScaleGizmo != undefined) instance.uniformScaleGizmo = uniformScaleGizmo?.instance || uniformScaleGizmo
				uniformScaleGizmo = instance.uniformScaleGizmo
