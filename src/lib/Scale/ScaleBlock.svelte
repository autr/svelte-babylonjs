			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ScaleBlock(name) : {}
				...
				export let factor = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ScaleBlock]`, ...args) : null
