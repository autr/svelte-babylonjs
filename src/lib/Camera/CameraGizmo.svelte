			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.CameraGizmo(gizmoLayer) : {}
				...
				export let displayFrustum = undefined // [boolean] 
				...
				export let material = undefined // [standardmaterial] 
				...
				export let onClickedObservable = undefined // [observable] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CameraGizmo]`, ...args) : null
				...
				if (displayFrustum != undefined) instance.displayFrustum = displayFrustum?.instance || displayFrustum
				displayFrustum = instance.displayFrustum
				...
				if (onClickedObservable != undefined) instance.onClickedObservable = onClickedObservable?.instance || onClickedObservable
				onClickedObservable = instance.onClickedObservable
