			...
			<script>
				...
				*/
				...
				export let camera = undefined // [tcamera] * required
				// defines the camera the input manager belongs to
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.CameraInputsManager(camera) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CameraInputsManager]`, ...args) : null
