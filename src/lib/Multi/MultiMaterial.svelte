			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.MultiMaterial(name,scene) : {}
				...
				export let subMaterials = undefined // [array] 
				// 
				...
				export let getSubMaterial = (...args) => instance.getSubMaterial(...args)
				...
				export let ParseMultiMaterial = (...args) => instance.ParseMultiMaterial(...args)
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:MultiMaterial]`, ...args) : null
				...
				if (subMaterials != undefined) instance.subMaterials = subMaterials?.instance || subMaterials
				subMaterials = instance.subMaterials
