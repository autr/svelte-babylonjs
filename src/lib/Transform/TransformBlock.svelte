			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.TransformBlock(name) : {}
				...
				export let transform = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let vector = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let complementW = undefined // [number] 
				// defines the value to use to complement w value to transform it to a vector4
				

				export let complementZ = undefined // [number] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:TransformBlock]`, ...args) : null
				...
				if (complementW != undefined) instance.complementW = complementW?.instance || complementW
				complementW = instance.complementW
				if (complementZ != undefined) instance.complementZ = complementZ?.instance || complementZ
				complementZ = instance.complementZ
