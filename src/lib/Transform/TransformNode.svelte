			...
			<script>
				...
				*/
				...
				export let isPure = undefined // [boolean] 
				// 
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.TransformNode(name,scene,isPure) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:TransformNode]`, ...args) : null
				...
				if (isPure != undefined) instance.isPure = isPure?.instance || isPure
