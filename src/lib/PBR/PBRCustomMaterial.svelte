			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.PBRCustomMaterial(name,scene) : {}
				...
				export let CustomParts = undefined // [shaderalebdoparts] 
				// 
				...
				export let Fragment_Before_FinalColorComposition = (...args) => instance.Fragment_Before_FinalColorComposition(...args)
				...
				export let Fragment_Custom_Albedo = (...args) => instance.Fragment_Custom_Albedo(...args)

				export let Fragment_Custom_Alpha = (...args) => instance.Fragment_Custom_Alpha(...args)

				export let Fragment_Custom_MetallicRoughness = (...args) => instance.Fragment_Custom_MetallicRoughness(...args)

				export let Fragment_Custom_MicroSurface = (...args) => instance.Fragment_Custom_MicroSurface(...args)
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:PBRCustomMaterial]`, ...args) : null
