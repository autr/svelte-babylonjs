			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.PBRSpecularGlossinessMaterial(name,scene) : {}
				...
				// specifies the diffuse texture of the material. this can also contains the opacity value in its alphachannel.
				...
				export let glossiness = undefined // [number] 
				...
				export let specularGlossinessTexture = undefined // [nullable] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:PBRSpecularGlossinessMaterial]`, ...args) : null
				...
				if (glossiness != undefined) instance.glossiness = glossiness?.instance || glossiness
				...
				if (specularGlossinessTexture != undefined) instance.specularGlossinessTexture = specularGlossinessTexture?.instance || specularGlossinessTexture
				specularGlossinessTexture = instance.specularGlossinessTexture
