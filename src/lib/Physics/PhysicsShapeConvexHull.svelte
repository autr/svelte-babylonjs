			...
			<script>
				...
				*/
				...
				// the mesh to be used as topology infos for the convex hull
				...
				export let instance = browser ? new BB.PhysicsShapeConvexHull(mesh,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:PhysicsShapeConvexHull]`, ...args) : null
