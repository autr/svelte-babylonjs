			...
			<script>
				...
				*/
				...
				// the mesh topology that will be used to create the shape
				...
				export let instance = browser ? new BB.PhysicsShapeMesh(mesh,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:PhysicsShapeMesh]`, ...args) : null
