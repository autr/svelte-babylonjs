			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.PhysicsShapeCylinder(pointA,pointB,radius,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:PhysicsShapeCylinder]`, ...args) : null
