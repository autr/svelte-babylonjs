			...
			<script>
				...
				*/
				...
				export let _physicsHelper = undefined // [physicshelper] * required
				// a physics helper
				...
				// the origin position of the gravitational field event
				...
				export let instance = browser ? new BB.PhysicsGravitationalFieldEvent(_physicsHelper,_scene,_origin,_options) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:PhysicsGravitationalFieldEvent]`, ...args) : null
					...
					const unsubscribe = bbIniting.subscribe( v => {
						...
						timeout = setTimeout( e => {
							...
							if (!$bbIniting) {
												...
												if (_physicsHelper != undefined) instance._physicsHelper = _physicsHelper?.instance || _physicsHelper
				_physicsHelper = instance._physicsHelper
