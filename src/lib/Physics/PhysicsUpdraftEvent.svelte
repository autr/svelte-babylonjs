			...
			<script>
				...
				*/
				...
				// the origin position of the updraft
				

				export let _options = undefined // [physicsupdrafteventoptions] * required
				// the options for the updraft event
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.PhysicsUpdraftEvent(_scene,_origin,_options) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:PhysicsUpdraftEvent]`, ...args) : null
