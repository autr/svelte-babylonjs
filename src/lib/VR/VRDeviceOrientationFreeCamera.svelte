			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.VRDeviceOrientationFreeCamera(name,position,scene,compensateDistortion,vrCameraMetrics) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:VRDeviceOrientationFreeCamera]`, ...args) : null
