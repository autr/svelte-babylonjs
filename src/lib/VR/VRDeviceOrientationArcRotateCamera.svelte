			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.VRDeviceOrientationArcRotateCamera(name,alpha,beta,radius,target,scene,compensateDistortion,vrCameraMetrics) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:VRDeviceOrientationArcRotateCamera]`, ...args) : null
