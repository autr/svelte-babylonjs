			...
			<script>
				...
				*/
				...
				export let vrCameraMetrics = undefined // [vrcamerametrics] 
				// defines the vr metrics associated to the camera
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.VRDeviceOrientationGamepadCamera(name,position,scene,compensateDistortion,vrCameraMetrics) : {}
				...
				export let disablePointerInputWhenUsingDeviceOrientation = undefined // [boolean] 
				// 
				...
				export let enableHorizontalDragging = (...args) => instance.enableHorizontalDragging(...args)
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:VRDeviceOrientationGamepadCamera]`, ...args) : null
				...
				if (vrCameraMetrics != undefined) instance.vrCameraMetrics = vrCameraMetrics?.instance || vrCameraMetrics
				vrCameraMetrics = instance.vrCameraMetrics
				...
				if (disablePointerInputWhenUsingDeviceOrientation != undefined) instance.disablePointerInputWhenUsingDeviceOrientation = disablePointerInputWhenUsingDeviceOrientation?.instance || disablePointerInputWhenUsingDeviceOrientation
				disablePointerInputWhenUsingDeviceOrientation = instance.disablePointerInputWhenUsingDeviceOrientation
