			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.DepthReducer(camera) : {}
				...
				export let depthRenderer = undefined // [nullable] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:DepthReducer]`, ...args) : null
				...
				depthRenderer = instance.depthRenderer
