			...
			<script>
				...
				*/
				...
				export let sound = undefined // [sound] * required
				// defines the sound to stop
				...
				export let instance = browser ? new BB.StopSoundAction(triggerOptions,sound,condition) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:StopSoundAction]`, ...args) : null
				...
				if (sound != undefined) instance.sound = sound?.instance || sound
