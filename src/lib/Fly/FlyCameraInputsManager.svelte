			...
			<script>
				...
				*/
				...
				export let camera = undefined // [flycamera] * required
				// defines the camera the inputs belong to.
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.FlyCameraInputsManager(camera) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:FlyCameraInputsManager]`, ...args) : null
