			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.PassCubePostProcess(name,options,camera,samplingMode,engine,reusable,textureType,blockCompilation) : {}
				...
				export let face = undefined // [number] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:PassCubePostProcess]`, ...args) : null
