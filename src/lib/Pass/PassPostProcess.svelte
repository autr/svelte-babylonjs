			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.PassPostProcess(name,options,camera,samplingMode,engine,reusable,textureType,blockCompilation) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:PassPostProcess]`, ...args) : null
