			...
			<script>
				...
				*/
				...
				export let storeEffectOnSubMeshes = undefined // [boolean] 
				// true to store effect on submeshes, false to store the effect directly in the material class.
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.ShaderMaterial(name,scene,shaderPath,options,storeEffectOnSubMeshes) : {}
				...
				export let setColor3Array = (...args) => instance.setColor3Array(...args)

				export let setColor4 = (...args) => instance.setColor4(...args)

				export let setColor4Array = (...args) => instance.setColor4Array(...args)
				...
				export let setQuaternionArray = (...args) => instance.setQuaternionArray(...args)
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ShaderMaterial]`, ...args) : null
				...
				if (storeEffectOnSubMeshes != undefined) instance.storeEffectOnSubMeshes = storeEffectOnSubMeshes?.instance || storeEffectOnSubMeshes
				storeEffectOnSubMeshes = instance.storeEffectOnSubMeshes
