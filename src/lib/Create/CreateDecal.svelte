			...
			<script>
				...
				*/
				...
				export let sourceMesh = undefined // [abstractmesh] * required
				...
				export let instance = browser ? BB.MeshBuilder.CreateDecal(name,sourceMesh,options) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CreateDecal]`, ...args) : null
