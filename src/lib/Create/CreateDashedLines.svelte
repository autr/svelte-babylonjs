			...
			<script>
				...
				/* 
					...
					useVertexAlpha (readonly) 
					useVertexColor (readonly) 
				*/
				...
				export let options = undefined // [type literal] * required
				...
				export let instance = browser ? BB.MeshBuilder.CreateDashedLines(name,options,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CreateDashedLines]`, ...args) : null
