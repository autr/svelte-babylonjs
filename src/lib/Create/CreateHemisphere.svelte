			...
			<script>
				...
				*/
				...
				export let instance = browser ? BB.HemisphereBuilder.CreateHemisphere(name,options,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CreateHemisphere]`, ...args) : null
