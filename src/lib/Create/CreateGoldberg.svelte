			...
			<script>
				...
				*/
				...
				export let options = undefined // [goldbergcreationoption] * required
				...
				export let instance = browser ? BB.MeshBuilder.CreateGoldberg(name,options,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CreateGoldberg]`, ...args) : null
