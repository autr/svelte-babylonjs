			...
			<script>
				...
				*/
				...
				export let instance = browser ? BB.MeshBuilder.CreateGroundFromHeightMap(name,url,options,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CreateGroundFromHeightMap]`, ...args) : null
