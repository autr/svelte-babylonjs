			...
			<script>
				...
				*/
				...
				export let options = undefined // [icreatecapsuleoptions] 
				...
				export let instance = browser ? BB.MeshBuilder.CreateCapsule(name,options,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CreateCapsule]`, ...args) : null
