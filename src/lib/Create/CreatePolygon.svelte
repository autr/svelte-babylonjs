			...
			<script>
				...
				*/
				...
				export let instance = browser ? BB.PolygonBuilder.CreatePolygon(name,options,scene,earcutInjection) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CreatePolygon]`, ...args) : null
