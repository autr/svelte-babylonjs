			...
			<script>
				...
				*/
				...
				export let instance = browser ? BB.PolyhedronBuilder.CreatePolyhedron(name,options,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CreatePolyhedron]`, ...args) : null
