			...
			<script>
				...
				*/
				...
				export let polyhedraType = undefined // [number] * required
				// 
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.CreateIrregularPolyhedra(polyhedraType) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CreateIrregularPolyhedra]`, ...args) : null
				...
				polyhedraType = instance.polyhedraType
