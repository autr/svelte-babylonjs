			...
			<script>
				...
				*/
				...
				export let instance = browser ? BB.TiledPlaneBuilder.CreateTiledPlane(name,options,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CreateTiledPlane]`, ...args) : null
