			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.MorphTargetsBlock(name) : {}
				...
				export let normalOutput = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let positionOutput = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let tangent = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let tangentOutput = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let uvOutput = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:MorphTargetsBlock]`, ...args) : null
				...
				normalOutput = instance.normalOutput

				outputs = instance.outputs

				position = instance.position

				positionOutput = instance.positionOutput

				tangent = instance.tangent

				tangentOutput = instance.tangentOutput
				if (target != undefined) instance.target = target?.instance || target
				target = instance.target

				uv = instance.uv

				uvOutput = instance.uvOutput
