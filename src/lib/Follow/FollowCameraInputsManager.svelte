			...
			<script>
				...
				*/
				...
				export let camera = undefined // [followcamera] * required
				// defines the camera the inputs belong to
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.FollowCameraInputsManager(camera) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:FollowCameraInputsManager]`, ...args) : null
