			...
			<script>
				...
				*/
				...
				export let lockedTarget = undefined // [nullable] 
				// define the target of the camera
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.FollowCamera(name,position,scene,lockedTarget) : {}
				...
				export let cameraAcceleration = undefined // [number] 
				...
				export let heightOffset = undefined // [number] 
				...
				export let inputs = undefined // [followcamerainputsmanager] 
				...
				export let lowerHeightOffsetLimit = undefined // [nullable] 
				...
				export let lowerRotationOffsetLimit = undefined // [nullable] 
				...
				export let maxCameraSpeed = undefined // [number] 
				...
				export let rotationOffset = undefined // [number] 
				...
				export let upperHeightOffsetLimit = undefined // [nullable] 
				...
				export let upperRotationOffsetLimit = undefined // [nullable] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:FollowCamera]`, ...args) : null
				...
				if (cameraAcceleration != undefined) instance.cameraAcceleration = cameraAcceleration?.instance || cameraAcceleration
				cameraAcceleration = instance.cameraAcceleration
				...
				if (heightOffset != undefined) instance.heightOffset = heightOffset?.instance || heightOffset
				heightOffset = instance.heightOffset
				...
				if (lowerHeightOffsetLimit != undefined) instance.lowerHeightOffsetLimit = lowerHeightOffsetLimit?.instance || lowerHeightOffsetLimit
				lowerHeightOffsetLimit = instance.lowerHeightOffsetLimit
				...
				if (lowerRotationOffsetLimit != undefined) instance.lowerRotationOffsetLimit = lowerRotationOffsetLimit?.instance || lowerRotationOffsetLimit
				lowerRotationOffsetLimit = instance.lowerRotationOffsetLimit
				if (maxCameraSpeed != undefined) instance.maxCameraSpeed = maxCameraSpeed?.instance || maxCameraSpeed
				maxCameraSpeed = instance.maxCameraSpeed
				...
				if (rotationOffset != undefined) instance.rotationOffset = rotationOffset?.instance || rotationOffset
				...
				if (upperHeightOffsetLimit != undefined) instance.upperHeightOffsetLimit = upperHeightOffsetLimit?.instance || upperHeightOffsetLimit
				upperHeightOffsetLimit = instance.upperHeightOffsetLimit
				...
				if (upperRotationOffsetLimit != undefined) instance.upperRotationOffsetLimit = upperRotationOffsetLimit?.instance || upperRotationOffsetLimit
				upperRotationOffsetLimit = instance.upperRotationOffsetLimit
