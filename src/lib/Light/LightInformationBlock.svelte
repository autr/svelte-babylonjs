			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.LightInformationBlock(name) : {}
				...
				export let direction = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let shadowBias = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let shadowDepthRange = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let shadowDepthScale = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let shadowNormalBias = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:LightInformationBlock]`, ...args) : null
				...
				shadowDepthRange = instance.shadowDepthRange

				shadowDepthScale = instance.shadowDepthScale
