			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.LightBlock(name) : {}
				...
				export let diffuseColor = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let diffuseOutput = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let glossPower = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let glossiness = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let shadow = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let specularColor = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let specularOutput = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let light = undefined // [nullable] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:LightBlock]`, ...args) : null
				...
				diffuseOutput = instance.diffuseOutput

				glossPower = instance.glossPower

				glossiness = instance.glossiness
				...
				specularOutput = instance.specularOutput
