			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ColorGradingTexture(url,sceneOrEngine,onLoad) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ColorGradingTexture]`, ...args) : null
