			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ColorMergerBlock(name) : {}
				...
				export let rgbIn = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let rgbOut = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let gSwizzle = undefined // [union] 
				...
				export let rSwizzle = undefined // [union] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ColorMergerBlock]`, ...args) : null
				...
				rgbIn = instance.rgbIn

				rgbOut = instance.rgbOut
				...
				if (aSwizzle != undefined) instance.aSwizzle = aSwizzle?.instance || aSwizzle
				aSwizzle = instance.aSwizzle
				if (bSwizzle != undefined) instance.bSwizzle = bSwizzle?.instance || bSwizzle
				bSwizzle = instance.bSwizzle
				if (comments != undefined) instance.comments = comments?.instance || comments
				comments = instance.comments
				if (gSwizzle != undefined) instance.gSwizzle = gSwizzle?.instance || gSwizzle
				gSwizzle = instance.gSwizzle
				...
				if (rSwizzle != undefined) instance.rSwizzle = rSwizzle?.instance || rSwizzle
				rSwizzle = instance.rSwizzle
