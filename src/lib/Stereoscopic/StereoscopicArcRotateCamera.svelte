			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.StereoscopicArcRotateCamera(name,alpha,beta,radius,target,interaxialDistance,isStereoscopicSideBySide,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:StereoscopicArcRotateCamera]`, ...args) : null
