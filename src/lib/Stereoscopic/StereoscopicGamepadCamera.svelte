			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.StereoscopicGamepadCamera(name,position,interaxialDistance,isStereoscopicSideBySide,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:StereoscopicGamepadCamera]`, ...args) : null
