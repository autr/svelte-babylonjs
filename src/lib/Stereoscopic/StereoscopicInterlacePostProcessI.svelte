			...
			<script>
				...
				/* 
					...
					isStereoscopicInterlaced  * required
					samplingMode  
					engine  
					reusable   
				...
				*/
				...
				export let isStereoscopicInterlaced = undefined // [boolean] * required
				...
				export let instance = browser ? new BB.StereoscopicInterlacePostProcessI(name,rigCameras,isStereoscopicHoriz,isStereoscopicInterlaced,samplingMode,engine,reusable) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:StereoscopicInterlacePostProcessI]`, ...args) : null
				...
				if (isStereoscopicInterlaced != undefined) instance.isStereoscopicInterlaced = isStereoscopicInterlaced?.instance || isStereoscopicInterlaced
				isStereoscopicInterlaced = instance.isStereoscopicInterlaced
