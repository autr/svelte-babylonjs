			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.StereoscopicUniversalCamera(name,position,interaxialDistance,isStereoscopicSideBySide,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:StereoscopicUniversalCamera]`, ...args) : null
