			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.Mesh(name,scene,parent,source,doNotCloneChildren,clonePhysicsImpostor) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:Mesh]`, ...args) : null
