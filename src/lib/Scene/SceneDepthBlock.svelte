			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.SceneDepthBlock(name) : {}
				...
				export let depth = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let force32itsFloat = undefined // [boolean] 
				...
				export let useNonLinearDepth = undefined // [boolean] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:SceneDepthBlock]`, ...args) : null
				...
				if (force32itsFloat != undefined) instance.force32itsFloat = force32itsFloat?.instance || force32itsFloat
				force32itsFloat = instance.force32itsFloat
				...
				if (useNonLinearDepth != undefined) instance.useNonLinearDepth = useNonLinearDepth?.instance || useNonLinearDepth
				useNonLinearDepth = instance.useNonLinearDepth
