			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.CellMaterial(name,scene) : {}
				...
				export let _computeHighLevel = undefined // [boolean] 
				// 
				...
				export let computeHighLevel = undefined // [boolean] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CellMaterial]`, ...args) : null
				...
				if (_computeHighLevel != undefined) instance._computeHighLevel = _computeHighLevel?.instance || _computeHighLevel
				_computeHighLevel = instance._computeHighLevel
				...
				if (computeHighLevel != undefined) instance.computeHighLevel = computeHighLevel?.instance || computeHighLevel
				computeHighLevel = instance.computeHighLevel
