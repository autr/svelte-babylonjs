			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.TBNBlock(name) : {}
				...
				export let row0 = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let row1 = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let row2 = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:TBNBlock]`, ...args) : null
