			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.TargetCamera(name,position,scene,setActiveOnSceneIfNoneActive) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:TargetCamera]`, ...args) : null
