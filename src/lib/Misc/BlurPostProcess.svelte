			...
			<script>
				...
				*/
				...
				export let _blockCompilation = undefined // [boolean] 
				...
				export let instance = browser ? new BB.BlurPostProcess(name,direction,kernel,options,camera,samplingMode,engine,reusable,textureType,defines,_blockCompilation,textureFormat) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:BlurPostProcess]`, ...args) : null
				...
				if (_blockCompilation != undefined) instance._blockCompilation = _blockCompilation?.instance || _blockCompilation
				_blockCompilation = instance._blockCompilation
