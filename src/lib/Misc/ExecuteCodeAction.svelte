			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ExecuteCodeAction(triggerOptions,func,condition) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ExecuteCodeAction]`, ...args) : null
