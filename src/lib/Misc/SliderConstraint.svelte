			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.SliderConstraint(pivotA,pivotB,axisA,axisB,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:SliderConstraint]`, ...args) : null
