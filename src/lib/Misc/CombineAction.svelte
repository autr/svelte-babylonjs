			...
			<script>
				...
				*/
				...
				export let children = undefined // [array] * required
				...
				export let enableChildrenConditions = undefined // [boolean] 
				// defines if the children actions conditions should be check before execution
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.CombineAction(triggerOptions,children,condition,enableChildrenConditions) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CombineAction]`, ...args) : null
				...
				if (children != undefined) instance.children = children?.instance || children
				children = instance.children
				if (condition != undefined) instance.condition = condition?.instance || condition
				condition = instance.condition
				if (enableChildrenConditions != undefined) instance.enableChildrenConditions = enableChildrenConditions?.instance || enableChildrenConditions
				enableChildrenConditions = instance.enableChildrenConditions
