			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.WorleyNoise3DBlock(name) : {}
				...
				export let jitter = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let manhattanDistance = undefined // [boolean] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:WorleyNoise3DBlock]`, ...args) : null
				...
				if (manhattanDistance != undefined) instance.manhattanDistance = manhattanDistance?.instance || manhattanDistance
				manhattanDistance = instance.manhattanDistance
