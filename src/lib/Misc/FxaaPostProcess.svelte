			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.FxaaPostProcess(name,options,camera,samplingMode,engine,reusable,textureType) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:FxaaPostProcess]`, ...args) : null
