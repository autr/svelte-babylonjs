			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.GroundMesh(name,scene) : {}
				...
				export let subdivisions = undefined // [number] 
				// 
				

				export let subdivisionsX = undefined // [number] 
				// 
				

				export let subdivisionsY = undefined // [number] 
				// 
				...
				export let generateOctree = undefined // [boolean] 
				...
				export let getHeightAtCoordinates = (...args) => instance.getHeightAtCoordinates(...args)
				...
				export let getNormalAtCoordinates = (...args) => instance.getNormalAtCoordinates(...args)

				export let getNormalAtCoordinatesToRef = (...args) => instance.getNormalAtCoordinatesToRef(...args)
				...
				export let optimize = (...args) => instance.optimize(...args)
				...
				export let updateCoordinateHeights = (...args) => instance.updateCoordinateHeights(...args)
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:GroundMesh]`, ...args) : null
				...
				subdivisionsX = instance.subdivisionsX

				subdivisionsY = instance.subdivisionsY
				...
				if (generateOctree != undefined) instance.generateOctree = generateOctree?.instance || generateOctree
				generateOctree = instance.generateOctree
