			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.IncrementValueAction(triggerOptions,target,propertyPath,value,condition) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:IncrementValueAction]`, ...args) : null
