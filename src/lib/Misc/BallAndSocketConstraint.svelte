			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.BallAndSocketConstraint(pivotA,pivotB,axisA,axisB,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:BallAndSocketConstraint]`, ...args) : null
