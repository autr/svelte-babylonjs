			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.PrismaticConstraint(pivotA,pivotB,axisA,axisB,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:PrismaticConstraint]`, ...args) : null
