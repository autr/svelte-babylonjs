			...
			<script>
				...
				*/
				...
				export let gamepadInfo = undefined // [any] * required
				// the gamepad object from the browser
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.XRWindowsMotionController(gamepadInfo) : {}
				...
				export let onGripButtonStateChangedObservable = undefined // [observable] 
				// 
				

				export let onMenuButtonStateChangedObservable = undefined // [observable] 
				// 
				

				export let onThumbstickButtonStateChangedObservable = undefined // [observable] 
				// 
				

				export let onTouchpadButtonStateChangedObservable = undefined // [observable] 
				// 
				

				export let onTouchpadValuesChangedObservable = undefined // [observable] 
				// 
				

				export let onTriggerButtonStateChangedObservable = undefined // [observable] 
				// 
				...
				export let onThumbstickStateChangedObservable = undefined // [observable] 
				// fired when the thumbstick on this controller is clicked
				

				export let onThumbstickValuesChangedObservable = undefined // [observable] 
				// fired when the thumbstick on this controller is modified
				

				export let onTrackpadChangedObservable = undefined // [observable] 
				// fired when the touchpad button on this controller is modified
				

				export let onTrackpadValuesChangedObservable = undefined // [observable] 
				...
				export let thumbstickValues = undefined // [stickvalues] 
				// holds the thumbstick values (x,y)
				

				export let trackpad = undefined // [stickvalues] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:XRWindowsMotionController]`, ...args) : null
					...
					const unsubscribe = bbIniting.subscribe( v => {
						...
						timeout = setTimeout( e => {
							...
							if (!$bbIniting) {
												...
												if (gamepadInfo != undefined) instance.gamepadInfo = gamepadInfo?.instance || gamepadInfo
				gamepadInfo = instance.gamepadInfo
				...
				onGripButtonStateChangedObservable = instance.onGripButtonStateChangedObservable

				onMenuButtonStateChangedObservable = instance.onMenuButtonStateChangedObservable

				onThumbstickButtonStateChangedObservable = instance.onThumbstickButtonStateChangedObservable

				onTouchpadButtonStateChangedObservable = instance.onTouchpadButtonStateChangedObservable

				onTouchpadValuesChangedObservable = instance.onTouchpadValuesChangedObservable

				onTriggerButtonStateChangedObservable = instance.onTriggerButtonStateChangedObservable
				...
				if (onThumbstickStateChangedObservable != undefined) instance.onThumbstickStateChangedObservable = onThumbstickStateChangedObservable?.instance || onThumbstickStateChangedObservable
				onThumbstickStateChangedObservable = instance.onThumbstickStateChangedObservable
				if (onThumbstickValuesChangedObservable != undefined) instance.onThumbstickValuesChangedObservable = onThumbstickValuesChangedObservable?.instance || onThumbstickValuesChangedObservable
				onThumbstickValuesChangedObservable = instance.onThumbstickValuesChangedObservable
				if (onTrackpadChangedObservable != undefined) instance.onTrackpadChangedObservable = onTrackpadChangedObservable?.instance || onTrackpadChangedObservable
				onTrackpadChangedObservable = instance.onTrackpadChangedObservable
				if (onTrackpadValuesChangedObservable != undefined) instance.onTrackpadValuesChangedObservable = onTrackpadValuesChangedObservable?.instance || onTrackpadValuesChangedObservable
				onTrackpadValuesChangedObservable = instance.onTrackpadValuesChangedObservable
				...
				if (thumbstickValues != undefined) instance.thumbstickValues = thumbstickValues?.instance || thumbstickValues
				thumbstickValues = instance.thumbstickValues
				if (trackpad != undefined) instance.trackpad = trackpad?.instance || trackpad
				trackpad = instance.trackpad
