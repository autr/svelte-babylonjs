			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.EXT_mesh_gpu_instancing(exporter) : {}
				...
				export let postExportNodeAsync = (...args) => instance.postExportNodeAsync(...args)
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:EXT_mesh_gpu_instancing]`, ...args) : null
