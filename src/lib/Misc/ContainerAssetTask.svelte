			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ContainerAssetTask(name,meshesNames,rootUrl,sceneFilename,extension) : {}
				...
				export let loadedContainer = undefined // [assetcontainer] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ContainerAssetTask]`, ...args) : null
				...
				if (loadedContainer != undefined) instance.loadedContainer = loadedContainer?.instance || loadedContainer
				loadedContainer = instance.loadedContainer
