			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.DiscardBlock(name) : {}
				...
				export let cutoff = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:DiscardBlock]`, ...args) : null
