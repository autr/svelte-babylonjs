			...
			<script>
				...
				*/
				...
				// defines the object containing the boolean
				

				export let propertyPath = undefined // [string] * required
				// defines the path to the boolean property in the target object
				...
				export let instance = browser ? new BB.SwitchBooleanAction(triggerOptions,target,propertyPath,condition) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:SwitchBooleanAction]`, ...args) : null
