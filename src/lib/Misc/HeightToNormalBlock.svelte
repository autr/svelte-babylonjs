			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.HeightToNormalBlock(name) : {}
				...
				export let input = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let worldTangent = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let automaticNormalizationNormal = undefined // [boolean] 
				// defines that the worldnormal input will be normalized by the heighttonormal block before being used
				

				export let automaticNormalizationTangent = undefined // [boolean] 
				...
				export let generateInWorldSpace = undefined // [boolean] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:HeightToNormalBlock]`, ...args) : null
				...
				worldTangent = instance.worldTangent

				xyz = instance.xyz
				if (automaticNormalizationNormal != undefined) instance.automaticNormalizationNormal = automaticNormalizationNormal?.instance || automaticNormalizationNormal
				automaticNormalizationNormal = instance.automaticNormalizationNormal
				if (automaticNormalizationTangent != undefined) instance.automaticNormalizationTangent = automaticNormalizationTangent?.instance || automaticNormalizationTangent
				automaticNormalizationTangent = instance.automaticNormalizationTangent
				if (comments != undefined) instance.comments = comments?.instance || comments
				comments = instance.comments
				if (generateInWorldSpace != undefined) instance.generateInWorldSpace = generateInWorldSpace?.instance || generateInWorldSpace
				generateInWorldSpace = instance.generateInWorldSpace
