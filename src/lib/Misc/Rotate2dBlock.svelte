			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.Rotate2dBlock(name) : {}

				// ================ ACCESSORS ================

				
				export let angle = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:Rotate2dBlock]`, ...args) : null
