			...
			<script>
				...
				*/
				...
				export let triggerOptions = undefined // [any] 
				...
				export let instance = browser ? new BB.DoNothingAction(triggerOptions,condition) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:DoNothingAction]`, ...args) : null
