			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.SheenBlock(name) : {}
				...
				export let sheen = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:SheenBlock]`, ...args) : null
