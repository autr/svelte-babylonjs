			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ReplaceColorBlock(name) : {}
				...
				export let distance = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let reference = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let replacement = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let value = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ReplaceColorBlock]`, ...args) : null
