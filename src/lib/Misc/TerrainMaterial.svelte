			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.TerrainMaterial(name,scene) : {}
				...
				export let bumpTexture1 = undefined // [texture] 
				// 
				

				export let bumpTexture2 = undefined // [texture] 
				// 
				

				export let bumpTexture3 = undefined // [texture] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:TerrainMaterial]`, ...args) : null
				...
				if (bumpTexture1 != undefined) instance.bumpTexture1 = bumpTexture1?.instance || bumpTexture1
				bumpTexture1 = instance.bumpTexture1
				if (bumpTexture2 != undefined) instance.bumpTexture2 = bumpTexture2?.instance || bumpTexture2
				bumpTexture2 = instance.bumpTexture2
				if (bumpTexture3 != undefined) instance.bumpTexture3 = bumpTexture3?.instance || bumpTexture3
				bumpTexture3 = instance.bumpTexture3
