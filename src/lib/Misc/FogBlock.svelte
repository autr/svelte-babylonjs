			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.FogBlock(name) : {}
				...
				export let fogColor = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:FogBlock]`, ...args) : null
