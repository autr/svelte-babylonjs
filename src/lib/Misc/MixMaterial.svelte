			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.MixMaterial(name,scene) : {}
				...
				export let diffuseTexture1 = undefined // [texture] 
				// 
				

				export let diffuseTexture2 = undefined // [texture] 
				// 
				

				export let diffuseTexture3 = undefined // [texture] 
				// 
				

				export let diffuseTexture4 = undefined // [texture] 
				// 
				

				export let diffuseTexture5 = undefined // [texture] 
				// 
				

				export let diffuseTexture6 = undefined // [texture] 
				// 
				

				export let diffuseTexture7 = undefined // [texture] 
				// 
				

				export let diffuseTexture8 = undefined // [texture] 
				// 
				...
				export let mixTexture1 = undefined // [basetexture] 
				// 
				

				export let mixTexture2 = undefined // [basetexture] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:MixMaterial]`, ...args) : null
				...
				if (diffuseTexture1 != undefined) instance.diffuseTexture1 = diffuseTexture1?.instance || diffuseTexture1
				diffuseTexture1 = instance.diffuseTexture1
				if (diffuseTexture2 != undefined) instance.diffuseTexture2 = diffuseTexture2?.instance || diffuseTexture2
				diffuseTexture2 = instance.diffuseTexture2
				if (diffuseTexture3 != undefined) instance.diffuseTexture3 = diffuseTexture3?.instance || diffuseTexture3
				diffuseTexture3 = instance.diffuseTexture3
				if (diffuseTexture4 != undefined) instance.diffuseTexture4 = diffuseTexture4?.instance || diffuseTexture4
				diffuseTexture4 = instance.diffuseTexture4
				if (diffuseTexture5 != undefined) instance.diffuseTexture5 = diffuseTexture5?.instance || diffuseTexture5
				diffuseTexture5 = instance.diffuseTexture5
				if (diffuseTexture6 != undefined) instance.diffuseTexture6 = diffuseTexture6?.instance || diffuseTexture6
				diffuseTexture6 = instance.diffuseTexture6
				if (diffuseTexture7 != undefined) instance.diffuseTexture7 = diffuseTexture7?.instance || diffuseTexture7
				diffuseTexture7 = instance.diffuseTexture7
				if (diffuseTexture8 != undefined) instance.diffuseTexture8 = diffuseTexture8?.instance || diffuseTexture8
				diffuseTexture8 = instance.diffuseTexture8
				...
				if (mixTexture1 != undefined) instance.mixTexture1 = mixTexture1?.instance || mixTexture1
				mixTexture1 = instance.mixTexture1
				if (mixTexture2 != undefined) instance.mixTexture2 = mixTexture2?.instance || mixTexture2
				mixTexture2 = instance.mixTexture2
