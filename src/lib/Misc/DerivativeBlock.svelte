			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.DerivativeBlock(name) : {}
				...
				export let dx = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let dy = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:DerivativeBlock]`, ...args) : null
