			...
			<script>
				...
				*/
				...
				export let options = undefined // [rotationgizmooptions] 
				// more options
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.RotationGizmo(gizmoLayer,tessellation,useEulerRotation,thickness,gizmoManager,options) : {}
				...
				export let xGizmo = undefined // [iplanerotationgizmo] 
				// internal gizmo used for interactions on the x axis
				

				export let yGizmo = undefined // [iplanerotationgizmo] 
				// internal gizmo used for interactions on the y axis
				

				export let zGizmo = undefined // [iplanerotationgizmo] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:RotationGizmo]`, ...args) : null
