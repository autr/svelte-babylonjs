			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.BonesBlock(name) : {}
				...
				export let matricesIndices = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let matricesIndicesExtra = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let matricesWeights = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let matricesWeightsExtra = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:BonesBlock]`, ...args) : null
