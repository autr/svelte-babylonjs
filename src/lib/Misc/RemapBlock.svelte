			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.RemapBlock(name) : {}
				...
				export let sourceMax = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let sourceMin = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let targetMax = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let targetMin = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let sourceRange = undefined // [vector2] 
				// gets or sets the source range
				

				export let targetRange = undefined // [vector2] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:RemapBlock]`, ...args) : null
				...
				sourceMax = instance.sourceMax

				sourceMin = instance.sourceMin
				...
				if (sourceRange != undefined) instance.sourceRange = sourceRange?.instance || sourceRange
				sourceRange = instance.sourceRange
				if (targetRange != undefined) instance.targetRange = targetRange?.instance || targetRange
