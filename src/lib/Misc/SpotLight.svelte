			...
			<script>
				...
				*/
				...
				export let angle = undefined // [number] * required
				// the cone angle of the light in radians
				

				export let exponent = undefined // [number] * required
				...
				export let instance = browser ? new BB.SpotLight(name,position,direction,angle,exponent,scene) : {}
				...
				export let innerAngle = undefined // [number] 
				// 
				...
				export let projectionTexture = undefined // [nullable] 
				// 
				

				export let projectionTextureLightFar = undefined // [number] 
				// 
				

				export let projectionTextureLightNear = undefined // [number] 
				// 
				

				export let projectionTextureMatrix = undefined // [matrix] 
				// 
				

				export let projectionTextureProjectionLightMatrix = undefined // [matrix] 
				// 
				

				export let projectionTextureUpDirection = undefined // [vector3] 
				// 
				...
				export let shadowAngleScale = undefined // [number] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:SpotLight]`, ...args) : null
				...
				if (exponent != undefined) instance.exponent = exponent?.instance || exponent
				...
				if (innerAngle != undefined) instance.innerAngle = innerAngle?.instance || innerAngle
				innerAngle = instance.innerAngle
				...
				if (projectionTexture != undefined) instance.projectionTexture = projectionTexture?.instance || projectionTexture
				projectionTexture = instance.projectionTexture
				if (projectionTextureLightFar != undefined) instance.projectionTextureLightFar = projectionTextureLightFar?.instance || projectionTextureLightFar
				projectionTextureLightFar = instance.projectionTextureLightFar
				if (projectionTextureLightNear != undefined) instance.projectionTextureLightNear = projectionTextureLightNear?.instance || projectionTextureLightNear
				projectionTextureLightNear = instance.projectionTextureLightNear

				projectionTextureMatrix = instance.projectionTextureMatrix
				if (projectionTextureProjectionLightMatrix != undefined) instance.projectionTextureProjectionLightMatrix = projectionTextureProjectionLightMatrix?.instance || projectionTextureProjectionLightMatrix
				projectionTextureProjectionLightMatrix = instance.projectionTextureProjectionLightMatrix
				if (projectionTextureUpDirection != undefined) instance.projectionTextureUpDirection = projectionTextureUpDirection?.instance || projectionTextureUpDirection
				projectionTextureUpDirection = instance.projectionTextureUpDirection
				if (radius != undefined) instance.radius = radius?.instance || radius
				radius = instance.radius
				if (range != undefined) instance.range = range?.instance || range
				range = instance.range
				if (shadowAngleScale != undefined) instance.shadowAngleScale = shadowAngleScale?.instance || shadowAngleScale
				shadowAngleScale = instance.shadowAngleScale
