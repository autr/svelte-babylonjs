			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ClampBlock(name) : {}
				...
				export let maximum = undefined // [number] 
				// gets or sets the maximum range
				

				export let minimum = undefined // [number] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ClampBlock]`, ...args) : null
