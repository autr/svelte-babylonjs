			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.SmoothStepBlock(name) : {}
				...
				export let edge0 = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let edge1 = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:SmoothStepBlock]`, ...args) : null
