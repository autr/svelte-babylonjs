			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.BlackAndWhitePostProcess(name,options,camera,samplingMode,engine,reusable) : {}
				...
				export let degree = undefined // [number] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:BlackAndWhitePostProcess]`, ...args) : null
				...
				if (degree != undefined) instance.degree = degree?.instance || degree
