			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.TwirlBlock(name) : {}
				...
				export let center = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let offset = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:TwirlBlock]`, ...args) : null
