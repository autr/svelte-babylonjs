			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.InstancesBlock(name) : {}
				...
				export let instanceID = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let world0 = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let world1 = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let world2 = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let world3 = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:InstancesBlock]`, ...args) : null
				...
				world0 = instance.world0

				world1 = instance.world1

				world2 = instance.world2

				world3 = instance.world3
