			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.AnisotropyBlock(name) : {}
				...
				export let anisotropy = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:AnisotropyBlock]`, ...args) : null
