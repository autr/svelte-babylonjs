			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.FireMaterial(name,scene) : {}
				...
				export let distortionTexture = undefined // [nullable] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:FireMaterial]`, ...args) : null
				...
				if (distortionTexture != undefined) instance.distortionTexture = distortionTexture?.instance || distortionTexture
				distortionTexture = instance.distortionTexture
