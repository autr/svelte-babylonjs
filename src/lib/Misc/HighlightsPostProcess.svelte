			...
			<script>
				...
				*/
				...
				// type of texture for the post process (default: engine.texturetype_unsigned_int)
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.HighlightsPostProcess(name,options,camera,samplingMode,engine,reusable,textureType) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:HighlightsPostProcess]`, ...args) : null
