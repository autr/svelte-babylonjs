			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.VoronoiNoiseBlock(name) : {}
				...
				export let cells = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let density = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:VoronoiNoiseBlock]`, ...args) : null
