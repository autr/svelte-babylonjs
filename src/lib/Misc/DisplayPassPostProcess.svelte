			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.DisplayPassPostProcess(name,options,camera,samplingMode,engine,reusable) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:DisplayPassPostProcess]`, ...args) : null
