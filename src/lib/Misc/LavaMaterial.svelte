			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.LavaMaterial(name,scene) : {}
				...
				export let diffuseTexture = undefined // [basetexture] 
				// 
				...
				export let lowFrequencySpeed = undefined // [number] 
				// 
				...
				export let movingSpeed = undefined // [number] 
				// 
				

				export let noiseTexture = undefined // [basetexture] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:LavaMaterial]`, ...args) : null
				...
				if (lowFrequencySpeed != undefined) instance.lowFrequencySpeed = lowFrequencySpeed?.instance || lowFrequencySpeed
				lowFrequencySpeed = instance.lowFrequencySpeed
				...
				if (movingSpeed != undefined) instance.movingSpeed = movingSpeed?.instance || movingSpeed
				movingSpeed = instance.movingSpeed
