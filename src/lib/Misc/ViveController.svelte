			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ViveController(vrGamepad) : {}
				...
				export let onLeftButtonStateChangedObservable = undefined // [observable] 
				// 
				...
				export let onRightButtonStateChangedObservable = undefined // [observable] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ViveController]`, ...args) : null
				...
				onLeftButtonStateChangedObservable = instance.onLeftButtonStateChangedObservable

				onMenuButtonStateChangedObservable = instance.onMenuButtonStateChangedObservable

				onRightButtonStateChangedObservable = instance.onRightButtonStateChangedObservable
