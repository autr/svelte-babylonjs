			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.IridescenceBlock(name) : {}
				...
				export let iridescence = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:IridescenceBlock]`, ...args) : null
				...
				iridescence = instance.iridescence
