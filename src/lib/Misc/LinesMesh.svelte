			...
			<script>
				...
				*/
				...
				export let useVertexColor = undefined // [boolean] 
				// defines if this linesmesh supports vertex color
				

				export let useVertexAlpha = undefined // [boolean] 
				// defines if this linesmesh supports vertex alpha
				

				export let material = undefined // [material] 
				// material to use to draw the line. if not provided, will create a new one
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.LinesMesh(name,scene,parent,source,doNotCloneChildren,useVertexColor,useVertexAlpha,material) : {}
				...
				export let checkCollisions = undefined // [] 
				// 
				...
				export let intersectionThreshold = undefined // [number] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:LinesMesh]`, ...args) : null
				...
				if (useVertexColor != undefined) instance.useVertexColor = useVertexColor?.instance || useVertexColor
				useVertexColor = instance.useVertexColor
				if (useVertexAlpha != undefined) instance.useVertexAlpha = useVertexAlpha?.instance || useVertexAlpha
				useVertexAlpha = instance.useVertexAlpha
				...
				if (intersectionThreshold != undefined) instance.intersectionThreshold = intersectionThreshold?.instance || intersectionThreshold
				intersectionThreshold = instance.intersectionThreshold
