			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ConditionalBlock(name) : {}
				...
				export let false = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let true = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let condition = undefined // [conditionalblockconditions] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ConditionalBlock]`, ...args) : null
