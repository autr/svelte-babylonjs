			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.TextFileAssetTask(name,url) : {}
				...
				export let text = undefined // [string] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:TextFileAssetTask]`, ...args) : null
				...
				if (text != undefined) instance.text = text?.instance || text
				text = instance.text
