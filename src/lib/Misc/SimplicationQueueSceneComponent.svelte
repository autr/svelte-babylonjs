			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.SimplicationQueueSceneComponent(scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:SimplicationQueueSceneComponent]`, ...args) : null
