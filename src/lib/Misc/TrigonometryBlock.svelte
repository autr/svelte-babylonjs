			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.TrigonometryBlock(name) : {}
				...
				export let operation = undefined // [trigonometryblockoperations] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:TrigonometryBlock]`, ...args) : null
				...
				if (operation != undefined) instance.operation = operation?.instance || operation
