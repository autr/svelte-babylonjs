			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.ExtractHighlightsPostProcess(name,options,camera,samplingMode,engine,reusable,textureType,blockCompilation) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ExtractHighlightsPostProcess]`, ...args) : null
