			...
			<script>
				...
				*/
				...
				export let usefulFloatFirst = undefined // [boolean] 
				...
				export let instance = browser ? new BB.CascadedShadowGenerator(mapSize,light,usefulFloatFirst,camera) : {}

				// ================ ACCESSORS ================

				
				export let autoCalcDepthBounds = undefined // [boolean] 
				// 
				

				export let autoCalcDepthBoundsRefreshRate = undefined // [number] 
				// 
				...
				export let cascadeBlendPercentage = undefined // [number] 
				// 
				...
				export let depthClamp = undefined // [boolean] 
				// 
				...
				export let freezeShadowCastersBoundingInfo = undefined // [boolean] 
				// 
				

				export let lambda = undefined // [number] 
				// 
				...
				export let minDistance = undefined // [number] 
				// 
				...
				export let numCascades = undefined // [number] 
				// 
				

				export let shadowCastersBoundingInfo = undefined // [boundinginfo] 
				// 
				...
				export let getCascadeMaxExtents = (...args) => instance.getCascadeMaxExtents(...args)

				export let getCascadeMinExtents = (...args) => instance.getCascadeMinExtents(...args)

				export let getCascadeProjectionMatrix = (...args) => instance.getCascadeProjectionMatrix(...args)

				export let getCascadeTransformMatrix = (...args) => instance.getCascadeTransformMatrix(...args)

				export let getCascadeViewMatrix = (...args) => instance.getCascadeViewMatrix(...args)
				...
				export let setDepthRenderer = (...args) => instance.setDepthRenderer(...args)

				export let setMinMaxDistance = (...args) => instance.setMinMaxDistance(...args)

				export let setTransparencyShadow = (...args) => instance.setTransparencyShadow(...args)

				export let splitFrustum = (...args) => instance.splitFrustum(...args)
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:CascadedShadowGenerator]`, ...args) : null
				...
				if (usefulFloatFirst != undefined) instance.usefulFloatFirst = usefulFloatFirst?.instance || usefulFloatFirst
				usefulFloatFirst = instance.usefulFloatFirst
				if (camera != undefined) instance.camera = camera?.instance || camera
				camera = instance.camera
				if (autoCalcDepthBounds != undefined) instance.autoCalcDepthBounds = autoCalcDepthBounds?.instance || autoCalcDepthBounds
				autoCalcDepthBounds = instance.autoCalcDepthBounds
				if (autoCalcDepthBoundsRefreshRate != undefined) instance.autoCalcDepthBoundsRefreshRate = autoCalcDepthBoundsRefreshRate?.instance || autoCalcDepthBoundsRefreshRate
				autoCalcDepthBoundsRefreshRate = instance.autoCalcDepthBoundsRefreshRate
				...
				if (cascadeBlendPercentage != undefined) instance.cascadeBlendPercentage = cascadeBlendPercentage?.instance || cascadeBlendPercentage
				cascadeBlendPercentage = instance.cascadeBlendPercentage
				...
				if (depthClamp != undefined) instance.depthClamp = depthClamp?.instance || depthClamp
				depthClamp = instance.depthClamp
				...
				if (freezeShadowCastersBoundingInfo != undefined) instance.freezeShadowCastersBoundingInfo = freezeShadowCastersBoundingInfo?.instance || freezeShadowCastersBoundingInfo
				freezeShadowCastersBoundingInfo = instance.freezeShadowCastersBoundingInfo
				if (lambda != undefined) instance.lambda = lambda?.instance || lambda
				...
				if (numCascades != undefined) instance.numCascades = numCascades?.instance || numCascades
				numCascades = instance.numCascades
				if (shadowCastersBoundingInfo != undefined) instance.shadowCastersBoundingInfo = shadowCastersBoundingInfo?.instance || shadowCastersBoundingInfo
				shadowCastersBoundingInfo = instance.shadowCastersBoundingInfo
				...
				if (penumbraDarkness != undefined) instance.penumbraDarkness = penumbraDarkness?.instance || penumbraDarkness
				penumbraDarkness = instance.penumbraDarkness
				if (stabilizeCascades != undefined) instance.stabilizeCascades = stabilizeCascades?.instance || stabilizeCascades
				stabilizeCascades = instance.stabilizeCascades
