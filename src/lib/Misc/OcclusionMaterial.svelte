			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.OcclusionMaterial(name,scene) : {}
				...
				export let options = undefined // [ishadermaterialoptions] 
				// 
				...
				export let shaderPath = undefined // [any] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:OcclusionMaterial]`, ...args) : null
