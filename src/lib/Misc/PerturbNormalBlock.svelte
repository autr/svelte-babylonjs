			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.PerturbNormalBlock(name) : {}

				// ================ ACCESSORS ================

				
				export let TBN = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let normalMapColor = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let parallaxHeight = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let parallaxScale = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let strength = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let uvOffset = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let viewDirection = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let invertX = undefined // [boolean] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:PerturbNormalBlock]`, ...args) : null
				...
				normalMapColor = instance.normalMapColor

				output = instance.output

				outputs = instance.outputs

				parallaxHeight = instance.parallaxHeight

				parallaxScale = instance.parallaxScale
				...
				viewDirection = instance.viewDirection
				...
				if (invertX != undefined) instance.invertX = invertX?.instance || invertX
				invertX = instance.invertX
