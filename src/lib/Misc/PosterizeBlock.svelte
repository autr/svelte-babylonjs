			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.PosterizeBlock(name) : {}
				...
				export let steps = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:PosterizeBlock]`, ...args) : null
