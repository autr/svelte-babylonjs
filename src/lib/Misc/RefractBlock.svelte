			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.RefractBlock(name) : {}
				...
				export let incident = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let ior = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:RefractBlock]`, ...args) : null
