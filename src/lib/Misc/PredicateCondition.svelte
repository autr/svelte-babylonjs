			...
			<script>
				...
				*/
				...
				export let predicate = undefined // [reflection] * required
				// defines the predicate function used to validate the condition
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.PredicateCondition(actionManager,predicate) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:PredicateCondition]`, ...args) : null
				...
				if (predicate != undefined) instance.predicate = predicate?.instance || predicate
