			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.OculusTouchController(vrGamepad) : {}
				...
				export let onAButtonStateChangedObservable = undefined // [observable] 
				// 
				

				export let onBButtonStateChangedObservable = undefined // [observable] 
				// 
				

				export let onXButtonStateChangedObservable = undefined // [observable] 
				// 
				

				export let onYButtonStateChangedObservable = undefined // [observable] 
				// 
				...
				export let onSecondaryTriggerStateChangedObservable = undefined // [observable] 
				// fired when the secondary trigger on this controller is modified
				

				export let onThumbRestChangedObservable = undefined // [observable] 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:OculusTouchController]`, ...args) : null
				...
				onAButtonStateChangedObservable = instance.onAButtonStateChangedObservable

				onBButtonStateChangedObservable = instance.onBButtonStateChangedObservable

				onXButtonStateChangedObservable = instance.onXButtonStateChangedObservable

				onYButtonStateChangedObservable = instance.onYButtonStateChangedObservable
				...
				if (onSecondaryTriggerStateChangedObservable != undefined) instance.onSecondaryTriggerStateChangedObservable = onSecondaryTriggerStateChangedObservable?.instance || onSecondaryTriggerStateChangedObservable
				onSecondaryTriggerStateChangedObservable = instance.onSecondaryTriggerStateChangedObservable
				if (onThumbRestChangedObservable != undefined) instance.onThumbRestChangedObservable = onThumbRestChangedObservable?.instance || onThumbRestChangedObservable
				onThumbRestChangedObservable = instance.onThumbRestChangedObservable
