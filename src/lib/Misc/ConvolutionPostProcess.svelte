			...
			<script>
				...
				*/
				...
				export let kernel = undefined // [array] * required
				...
				export let instance = browser ? new BB.ConvolutionPostProcess(name,kernel,options,camera,samplingMode,engine,reusable,textureType) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ConvolutionPostProcess]`, ...args) : null
