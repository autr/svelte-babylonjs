			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.TextureDome(name,textureUrlOrElement,options,scene,onError) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:TextureDome]`, ...args) : null
