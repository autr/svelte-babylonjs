			...
			<script>
				...
				*/
				...
				export let fragmentOnly = undefined // [boolean] 
				// 
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.TextureBlock(name,fragmentOnly) : {}
				...
				export let uv = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:TextureBlock]`, ...args) : null
				...
				name = instance.name
				if (fragmentOnly != undefined) instance.fragmentOnly = fragmentOnly?.instance || fragmentOnly
				fragmentOnly = instance.fragmentOnly
