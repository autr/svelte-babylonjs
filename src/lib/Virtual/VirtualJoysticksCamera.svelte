			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.VirtualJoysticksCamera(name,position,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:VirtualJoysticksCamera]`, ...args) : null
