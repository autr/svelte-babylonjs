			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.Engine(canvasOrContext,antialias,options,adaptToDeviceRatio) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:Engine]`, ...args) : null
