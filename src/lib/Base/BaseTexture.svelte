			...
			<script>
				...
				*/
				...
				export let internalTexture = undefined // [nullable] 
				// define the internal texture associated with the texture
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.BaseTexture(sceneOrEngine,internalTexture) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:BaseTexture]`, ...args) : null
