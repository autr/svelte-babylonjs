			...
			<script>
				...
				*/
				...
				export let maxDistance = undefined // [number] * required
				// 
				...
				export let instance = browser ? new BB.DistanceConstraint(maxDistance,scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:DistanceConstraint]`, ...args) : null
