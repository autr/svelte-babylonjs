			...
			<script>
				...
				*/
				...
				export let camera = undefined // [freecamera] * required
				// defines the camera the inputs belong to
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.FreeCameraInputsManager(camera) : {}
				...
				export let addDeviceOrientation = (...args) => instance.addDeviceOrientation(...args)

				export let addGamepad = (...args) => instance.addGamepad(...args)

				export let addKeyboard = (...args) => instance.addKeyboard(...args)

				export let addMouse = (...args) => instance.addMouse(...args)

				export let addMouseWheel = (...args) => instance.addMouseWheel(...args)

				export let addTouch = (...args) => instance.addTouch(...args)

				export let addVirtualJoystick = (...args) => instance.addVirtualJoystick(...args)
				...
				export let removeMouse = (...args) => instance.removeMouse(...args)

				export let removeMouseWheel = (...args) => instance.removeMouseWheel(...args)
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:FreeCameraInputsManager]`, ...args) : null
