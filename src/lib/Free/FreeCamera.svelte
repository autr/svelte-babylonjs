			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.FreeCamera(name,position,scene,setActiveOnSceneIfNoneActive) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:FreeCamera]`, ...args) : null
