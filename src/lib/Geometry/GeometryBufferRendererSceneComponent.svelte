			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.GeometryBufferRendererSceneComponent(scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:GeometryBufferRendererSceneComponent]`, ...args) : null
