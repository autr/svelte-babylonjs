			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.FresnelBlock(name) : {}

				// ================ ACCESSORS ================

				
				export let bias = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let fresnel = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let power = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:FresnelBlock]`, ...args) : null
