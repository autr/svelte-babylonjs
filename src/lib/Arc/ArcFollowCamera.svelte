			...
			<script>
				...
				*/
				...
				export let target = undefined // [nullable] * required
				...
				export let instance = browser ? new BB.ArcFollowCamera(name,alpha,beta,radius,target,scene) : {}
				...
				export let setMeshTarget = (...args) => instance.setMeshTarget(...args)
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:ArcFollowCamera]`, ...args) : null
