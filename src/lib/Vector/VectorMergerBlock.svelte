			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.VectorMergerBlock(name) : {}
				...
				export let w = undefined // [nodematerialconnectionpoint] 
				// 
				...
				export let x = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let xy = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let xyIn = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let xyOut = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let xyz = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let xyzIn = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let xyzOut = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let xyzw = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let xyzwIn = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let y = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let z = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let zwIn = undefined // [nodematerialconnectionpoint] 
				// 
				

				export let zwOut = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:VectorMergerBlock]`, ...args) : null
				...
				xyOut = instance.xyOut

				xyz = instance.xyz

				xyzIn = instance.xyzIn

				xyzOut = instance.xyzOut

				xyzw = instance.xyzw

				xyzwIn = instance.xyzwIn
				...
				if (wSwizzle != undefined) instance.wSwizzle = wSwizzle?.instance || wSwizzle
				wSwizzle = instance.wSwizzle
				if (xSwizzle != undefined) instance.xSwizzle = xSwizzle?.instance || xSwizzle
				xSwizzle = instance.xSwizzle
				if (ySwizzle != undefined) instance.ySwizzle = ySwizzle?.instance || ySwizzle
				ySwizzle = instance.ySwizzle
				if (zSwizzle != undefined) instance.zSwizzle = zSwizzle?.instance || zSwizzle
				zSwizzle = instance.zSwizzle
