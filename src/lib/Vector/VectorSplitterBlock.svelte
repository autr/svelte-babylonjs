			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.VectorSplitterBlock(name) : {}
				...
				export let zw = undefined // [nodematerialconnectionpoint] 
				// 
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:VectorSplitterBlock]`, ...args) : null
