			...
			<script>
				...
				*/
				...
				// the axis which the gizmo will be able to drag on
				...
				export let instance = browser ? new BB.AxisDragGizmo(dragAxis,color,gizmoLayer,parent,thickness) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:AxisDragGizmo]`, ...args) : null
