			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.PrePassRendererSceneComponent(scene) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:PrePassRendererSceneComponent]`, ...args) : null
