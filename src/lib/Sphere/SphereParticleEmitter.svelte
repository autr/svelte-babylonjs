			...
			<script>
				...
				*/
				...
				export let instance = browser ? new BB.SphereParticleEmitter(radius,radiusRange,directionRandomizer) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:SphereParticleEmitter]`, ...args) : null
