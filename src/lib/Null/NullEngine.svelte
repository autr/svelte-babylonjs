			...
			<script>
				...
				*/
				...
				export let options = undefined // [nullengineoptions] 
				// 
				

				// ================ CLASS INSTANCE ================

				export let instance = browser ? new BB.NullEngine(options) : {}
				...
				const DEBUG = (...args) => $bbDebug ? console.log(`[${name}:NullEngine]`, ...args) : null
